export default function Footer() {
  return (
    <footer className="mt-24 border-t-[1px] border-zinc-700 border-solid flex items-center justify-between pt-6 pb-12">
      <span className="text-lg text-white">noveanre</span>
      <div className="flex gap-4">
        <a href="mailto:noveanrer@gmail.com">
          ...
          >
            <title>noveanrer@gmail.com</title>
        ...
        <a href="https://github.com/kraken-afk">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            ...
            className="fill-white"
          >
            <title>https://github.com/kraken-afk</title>
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
        ...
        <a href="https://www.linkedin.com/in/noveanrer">
          <svg
            ...
            className="fill-white"
          >
            <title>www.linkedin.com/in/noveanrer</title>
